...
define("check", ["jquery"], function(){});

define('login',['jquery', 'check'], function ($, undefined) {
    var Controller = {
            ...
            $("#loginSubmit").on("click", function(){
                ...
                jQuery.ajax({
                    ...
                    "success": function(result){
                        if(result.ret){
                           var redirect_uri = Controller.getQueryString("redirect_uri");
                           if (result.next != "") {
                               window.location.href = result.next;
                           }else if (redirect_uri != null && redirect_uri != ""){
                               window.location.href = redirect_uri + "?code=" + result.code;
                           }else{
                               window.location.href = "/";
                           }
                           return true;
                        }else{
                           $("#errorP").text(result.msg);
